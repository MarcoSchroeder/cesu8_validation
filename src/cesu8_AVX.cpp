...
{
    static __m256i const lookup_table3 = _mm256_setr_epi8(CESU8_IMPLEMENTATION_LOOKUPTABLE_3_VALUES, CESU8_IMPLEMENTATION_LOOKUPTABLE_3_VALUES);
    static __m256i const lookup_table2 = _mm256_setr_epi8(CESU8_IMPLEMENTATION_LOOKUPTABLE_2_VALUES, CESU8_IMPLEMENTATION_LOOKUPTABLE_2_VALUES);
    static __m256i const lookup_table1_high = _mm256_setr_epi8(CESU8_IMPLEMENTATION_LOOKUPTABLE_1HIGH_VALUES, CESU8_IMPLEMENTATION_LOOKUPTABLE_1HIGH_VALUES);
    static __m256i const lookup_table1_low = _mm256_setr_epi8(CESU8_IMPLEMENTATION_LOOKUPTABLE_1LOW_VALUES, CESU8_IMPLEMENTATION_LOOKUPTABLE_1LOW_VALUES);

    __m256i prev_bytes = _mm256_setzero_si256(); // Zero values will be interpeted as preceding ascii in first loop iteration
    ...
    while (len >= 32) {
        ...
        __m256i bytes2 = _mm256_alignr_epi8(bytes3, _mm256_permute2x128_si256(prev_bytes, bytes3, 0x21), 15);
        __m256i bytes1 = _mm256_alignr_epi8(bytes3, _mm256_permute2x128_si256(prev_bytes, bytes3, 0x21), 14);

        // Extract header bits by shifting entire register right by 4-bit and masking lowest 4 bits in each lane
        __m256i nibbles3 = _mm256_and_si256(_mm256_srli_epi16(bytes3, 4), _mm256_set1_epi8(0x0F));
        __m256i nibbles2 = _mm256_and_si256(_mm256_srli_epi16(bytes2, 4), _mm256_set1_epi8(0x0F));
        __m256i nibbles1_low = _mm256_and_si256(bytes1, _mm256_set1_epi8(0x0F));
        __m256i nibbles1_high = _mm256_and_si256(_mm256_srli_epi16(bytes1, 4), _mm256_set1_epi8(0x0F));
        ...
        __m256i temp = _mm256_and_si256(result2, _mm256_and_si256(result1_high, result1_low));
        ...
        __m256i shifted_high_surrogates = _mm256_alignr_epi8(high_surrogates, _mm256_permute2x128_si256(prev_high_surrogates, high_surrogates, 0x21), 13);
