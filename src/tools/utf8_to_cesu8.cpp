...
int main(int argc, char* argv[]) {
    ...
    if(!cesu8::is_valid_cesu8_scalar((unsigned char*)cesu8_buffer.data(), cesu8_buffer.size())) {
    ...
    std::cout << "Successfully converted \"" << argv[1] << "\" to cesu8 and stored as \"" << argv[2] << "\"" << std::endl;
